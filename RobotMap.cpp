...
void RobotMap::init() {
	...
	// Re-address CAN Bus for FrisbeeBot
	...
	throwerThrowerMotor = new CANJaguar(3);				// Front Shooter
	pickupWheelsRightPickupWheel = new CANJaguar(3);
	pickupWheelsLeftPickupWheel = new CANJaguar(7);		// Rear Shooter
