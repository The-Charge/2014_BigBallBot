...
/*
 * 	// Overwrite CAN Jaguar ID assignments to run code in Plywood on BigBallBot
 * 		
	driveTrainFrontLeftMotor = new CANJaguar(10);
	driveTrainCenterLeftMotor = new CANJaguar(12);
	driveTrainRearLeftMotor = new CANJaguar(2);
	driveTrainFrontRightMotor = new CANJaguar(16);
	driveTrainCenterRightMotor = new CANJaguar(8);
	driveTrainRearRightMotor = new CANJaguar(9);
*/
	// CAN Jaguar ID assignments to run code in Fisbee Bot

	driveTrainFrontLeftMotor = new CANJaguar(6);
	driveTrainCenterLeftMotor = new CANJaguar(14);	// set to non-existant Jag
	driveTrainRearLeftMotor = new CANJaguar(18);
	driveTrainFrontRightMotor = new CANJaguar(11);
	driveTrainCenterRightMotor = new CANJaguar(15);	// set to non-existant Jag
