...
AnalogChannel* RobotMap::distanceDeviceUltrasonicSensor = NULL;
...
void RobotMap::init() {
	...
	distanceDeviceUltrasonicSensor = new AnalogChannel(1, 1);
	lw->AddSensor("DistanceDevice", "UltrasonicSensor", distanceDeviceUltrasonicSensor);
