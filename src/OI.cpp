...
#include "Commands/PickupArmsMidwayLo2.h"
...
#include "Commands/PickupWheelsSetSpeed.h"
#include "Commands/PickupWheelsShort.h"
...
#include "Commands/Shoot2.h"
#include "Commands/ShootArmsRetract.h"
...
#include "Commands/WaitFor1Secs.h"
#include "Commands/WaitForXSecs.h"
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=INCLUDES
OI::OI() {
	// Process operator interface input here.
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
/*	showDistanceBtn = new DigitalIOButton(1);
	showDistanceBtn->WhenPressed(new ShowDistance());
	showTimeBtn = new DigitalIOButton(1);
	showTimeBtn->WhenPressed(new ShowTime());
	showTeamBtn = new DigitalIOButton(1);
	showTeamBtn->WhenPressed(new ShowTeam());
	shooterBlockBtn = new DigitalIOButton(1);
	shooterBlockBtn->WhenPressed(new ShooterBlock());
*/	shootBtn = new DigitalIOButton(9);
	shootBtn->WhenPressed(new Shoot());
/*	clockspringsHiBtn = new DigitalIOButton(1);
	clockspringsHiBtn->WhenPressed(new ClockspringsHigh());
	clockspringsMedBtn = new DigitalIOButton(1);
...
*/	pickupArmsRetractBtn = new DigitalIOButton(5);
	...
	joystickButton6r = new JoystickButton(shooterJoystick, 6);
	joystickButton6r->WhenPressed(new ThrowerShoot());
	shiftHighButton2 = new JoystickButton(shooterJoystick, 1);
	shiftHighButton2->WhenPressed(new ShifterHigh());
	shiftLowButton2 = new JoystickButton(shooterJoystick, 2);
	shiftLowButton2->WhenPressed(new ShifterLow());
	resetJagsBtn2 = new JoystickButton(shooterJoystick, 11);
	resetJagsBtn2->WhenPressed(new ResetJags());
	driverJoystick = new Joystick(1);
	
	joystickButton12 = new JoystickButton(driverJoystick, 12);
	joystickButton12->WhileHeld(new PickupArmsExtend());
	joystickButton10 = new JoystickButton(driverJoystick, 10);
	joystickButton10->WhenPressed(new PickupArmsMidwayLo());
	joystickButton8 = new JoystickButton(driverJoystick, 8);
	joystickButton8->WhenPressed(new PickupArmsRetract());
	joystickButton9 = new JoystickButton(driverJoystick, 9);
	joystickButton9->WhenPressed(new PickupWheelsReverseFast());
	joystickButton7 = new JoystickButton(driverJoystick, 7);
	joystickButton7->WhenPressed(new PickupWheelsForward());
	joystickButton6 = new JoystickButton(driverJoystick, 6);
	joystickButton6->WhenPressed(new ThrowerShoot());
	joystickButton11 = new JoystickButton(driverJoystick, 11);
	joystickButton11->WhenPressed(new PickupWheelsOff());
	...
	SmartDashboard::PutData("AutoShoot2", new AutoShoot2());
	SmartDashboard::PutData("WaitFor1Secs", new WaitFor1Secs());
	SmartDashboard::PutData("AutoPickArmsMidway", new AutoPickArmsMidway());
	SmartDashboard::PutData("ShootArmsRetract", new ShootArmsRetract());
	SmartDashboard::PutData("PickupArmsMidwayLo2", new PickupArmsMidwayLo2());
	SmartDashboard::PutData("Pickup Wheels Short", new PickupWheelsShort());
	...
	showTeamBtn->WhenPressed(new ShowTeam());
	shooterBlockBtn = new DigitalIOButton(8);
	shooterBlockBtn->WhenPressed(new ShooterBlock());
