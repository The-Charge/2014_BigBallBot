...
ThrowerShoot::ThrowerShoot() {
	...
	Robot::netTable->PutNumber("ThrowerShoot::LeftBoundCock", LEFT_BOUND_COCK);
	Robot::netTable->PutNumber("ThrowerShoot::RightBoundCock", RIGHT_BOUND_COCK);
}
...
bool ThrowerShoot::IsFinished() {
	...
	float leftBoundCock = Robot::netTable->GetNumber("ThrowerShoot::LeftBoundCock",LEFT_BOUND_COCK);
	float rightBoundCock = Robot::netTable->GetNumber("ThrowerShoot::RightBoundCock",RIGHT_BOUND_COCK);
