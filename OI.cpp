...
OI::OI() {
	...
	showDistanceBtn = new DigitalIOButton(8);
	showDistanceBtn->WhenPressed(new ShowDistance());
	showTimeBtn = new DigitalIOButton(7);
	showTimeBtn->WhenPressed(new ShowTime());
	showTeamBtn = new DigitalIOButton(6);
	showTeamBtn->WhenPressed(new ShowTeam());
	shooterUpBtn = new DigitalIOButton(5);
	shooterUpBtn->WhenPressed(new ThrowerUp());
	shootBtn = new DigitalIOButton(4);
	shootBtn->WhenPressed(new ThrowerShoot());
	clockspringsHiBtn = new DigitalIOButton(3);
	clockspringsHiBtn->WhenPressed(new ClockspringsHigh());
	clockspringsMedBtn = new DigitalIOButton(2);
	...
	pickupArmsMidwayHiBtn = new DigitalIOButton(6);
	pickupArmsMidwayHiBtn->WhenPressed(new PickupArmsMidwayHi());
	pickupArmsMidwayLoBtn = new DigitalIOButton(5);
