...
OI::OI() {
	...
	showDistanceBtn = new DigitalIOButton(16);
	showDistanceBtn->WhenPressed(new ShowDistance());
	showTimeBtn = new DigitalIOButton(15);
	showTimeBtn->WhenPressed(new ShowTime());
	shooterUp = new DigitalIOButton(13);
	shooterUp->WhenPressed(new ThrowerUp());
	shoot = new DigitalIOButton(12);
	shoot->WhenPressed(new ThrowerShoot());
	clockspringsLowBtn = new DigitalIOButton(11);
	clockspringsLowBtn->WhenPressed(new ClockspringsLow());
	clockspringsMedBtn = new DigitalIOButton(10);
	clockspringsMedBtn->WhenPressed(new ClockspringsMed());
	clockspringsHighBtn = new DigitalIOButton(9);
	clockspringsHighBtn->WhenPressed(new ClockspringsHigh());
	pickupArmsRetractBtn = new DigitalIOButton(7);
	pickupArmsRetractBtn->WhenPressed(new PickupArmsRetract());
	pickupArmsMidBtn = new DigitalIOButton(6);
	pickupArmsMidBtn->WhenPressed(new PickupArmsMidwayHi());
	pickupArmsExtendBtn = new DigitalIOButton(5);
	pickupArmsExtendBtn->WhenPressed(new PickupArmsMidwayLo());
