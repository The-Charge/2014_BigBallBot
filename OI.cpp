...
OI::OI() {
	...
	armMidwaylo = new JoystickButton(driverJoystick, 10);
	armMidwaylo->WhenPressed(new PickupArmsMidwayLo());
	armRetract = new JoystickButton(driverJoystick, 11);
	armRetract->WhenPressed(new PickupArmsRetract());
	armMidwayHi = new JoystickButton(driverJoystick, 9);
	armMidwayHi->WhenPressed(new PickupArmsMidwayHi());
	armExtend = new JoystickButton(driverJoystick, 7);
	armExtend->WhenPressed(new PickupArmsExtend());
